...
- R4. Users can view, add, edit, delete, and reorder categories used to group exercises.
...
- **KTD6 — Reordering uses move-up/move-down controls**, not drag-and-drop, for categories, routine-section exercises, and target sets within a section. Keeps v1 dependency-light; drag-and-drop can be layered on later without an API or schema change.
...
- **Files:**
  ...
  - `src/routes/export.tsx` (download trigger)
